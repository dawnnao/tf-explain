...
#%%
file_name = 'dataset_10017_reshaped_tf_spg_rp.mat'
...
def model(data_input1, data_input2, data_input3, data_input4, data_output):
    ...
    input_spec = Input(shape=(width_image, width_image, 1), name='Input_spec')
    ...
    conv_spec_1 = Conv2D(32, (3, 3), activation='relu', input_shape=(width_image, width_image, 1), name='Conv_spec_1')(input_spec)
    maxpool_spec_1 = MaxPooling2D((2, 2), name='Maxpool_spec_1')(conv_spec_1)
    conv_spec_2 = Conv2D(64, (3, 3), activation='relu', name='Conv_spec_2')(maxpool_spec_1)
    maxpool_spec_2 = MaxPooling2D((2, 2), name='Maxpool_spec_2')(conv_spec_2)
    conv_spec_3 = Conv2D(64, (3, 3), activation='relu', name='Conv_spec_3')(maxpool_spec_2)
    # print(conv_spec_3.output_shape)
    ...
    merged = concatenate([conv_time_3, conv_freq_3, conv_spec_3, conv_recc_3], axis=-1, name='Merged')  # , axis=-1, name='Merged'
    ...
    model = tf.keras.models.Model(inputs=[input_time, input_freq, input_spec, input_recc], outputs=[output])
...
data_input4 = np.expand_dims(images_train[:, :, :, 3], axis=-1)
...
data_input4_vali = np.expand_dims(images_vali[:, :, :, 3], axis=-1)
data_output_vali = labels_vali

model = model(data_input1, data_input2, data_input3, data_input4, data_output)
...
test_loss, test_acc = model.evaluate(x=[data_input1_vali, data_input2_vali, data_input3_vali, data_input4_vali],
                                     y=[data_output_vali], verbose=1)
...
for class_index in range(7):
    for input_index, name_of_conv in zip(range(4), ['Conv_time_3', 'Conv_freq_3', 'Conv_spec_3', 'Conv_recc_3']):
        ...
        img_explain2 = data_input2_vali[ind_in_images_vali[0:25], :, :, :].astype('float32')
