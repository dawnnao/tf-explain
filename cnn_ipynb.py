...
model.add(keras.layers.Conv2D(32, (3, 3), activation='relu', input_shape=(32, 32, 3), name='conv1'))
...
img_single = test_images[0:5, :, :, :]
# print(img_single.size)

data = (img_single, None)
class_index = 1
output = explainer.explain(data, model, "conv3", class_index)  # "conv1"
