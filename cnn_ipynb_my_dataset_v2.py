...
history = model.fit(x=[data_input1, data_input2, data_input3], y=[data_output], epochs=1, verbose=1,
...
for class_index in range(7):
    for input_index, name_of_conv in zip(range(3), ['Conv_time_3', 'Conv_freq_3', 'Conv_recc_3']):
